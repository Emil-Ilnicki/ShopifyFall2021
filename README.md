...
2. Users can continually search for different movies and the results will update (TR: 3)
![New Search](https://github.com/Emil-Ilnicki/ShopifyFall2021/blob/main/ShopifyChallengeScreenshots/newsearch.png)
3. Users can view their nominees and remove them (TR: 4)
...
4. Nominated movies will have their buttons disabled (TR: 5)
...
![Nominated 5 movies](https://github.com/Emil-Ilnicki/ShopifyFall2021/blob/main/ShopifyChallengeScreenshots/cannotnominatemorethan5movies.png)
...
![MongoDB Cluster View](https://github.com/Emil-Ilnicki/ShopifyFall2021/blob/main/ShopifyChallengeScreenshots/mongodb.png)
